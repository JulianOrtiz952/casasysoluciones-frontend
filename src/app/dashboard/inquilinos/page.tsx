    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                {[
                    { label: 'Total Usuarios', value: stats.total, color: 'bg-blue-600 dark:bg-blue-500 text-white shadow-blue-600/20', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
                    { label: 'Administradores', value: stats.admins, color: 'bg-purple-600 dark:bg-purple-500 text-white shadow-purple-600/20', icon: 'M12 11c0 3.517-1.009 6.799-2.753 9.571m-1.17-10.963a11.323 11.323 0 01-1.378-5.753m11.074 12.355A11.303 11.303 0 019 21a11.303 11.303 0 01-11.23-9.512C.33 6.945 3.866 3 8 3c4.135 0 7.67 3.945 7.231 8.488a11.326 11.326 0 01-1.378 5.753l1.17 1.407a11.316 11.316 0 011.054-2.693l1.17 1.406z' },
                    { label: 'Asistentes', value: stats.asistentes, color: 'bg-orange-600 dark:bg-orange-500 text-white shadow-orange-600/20', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
                    ...
                    { label: 'Arrendatarios', value: stats.arrendatarios, color: 'bg-emerald-600 dark:bg-emerald-500 text-white shadow-emerald-600/20', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
                ].map((s, i) => (
                    <div key={i} className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm flex items-center gap-4 hover:shadow-md transition-all group/card">
                        <div className={`w-12 h-12 ${s.color} rounded-xl flex items-center justify-center shrink-0 shadow-lg group-hover/card:scale-110 transition-transform`}>
